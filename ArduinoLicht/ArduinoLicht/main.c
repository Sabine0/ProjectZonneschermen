...
void run(void){
	if(test == 0){
		...
		/* Niet relevant voor de lichtsensor
		...
		*/
		...
		// Verstuur de lichtintensiteit en count
		if(data == 0xa0){
			transmit(licht);
			transmit(count);
		}
		...
		// Verstuur de lichtintensiteit en maximale lichtintensiteit voor uitrollen
